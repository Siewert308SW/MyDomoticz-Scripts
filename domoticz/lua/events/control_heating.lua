...
--
		...
		if devicechanged[lux_sensor.living]
			...
			and timebetween("08:45:00","22:29:59")
		then
...
--
		...
		if devicechanged[lux_sensor.upstairs]				
			...
			and (timebetween("22:30:00","23:59:59") or timebetween("00:00:00","08:44:59"))
			and weekend('false')			
		then
...
--
-- **********************************************************
-- Turn heating OFF when nobody @ home or adjust eco temp according outside temp
-- **********************************************************
--
		...
		if devicechanged[lux_sensor.porch]			
			and otherdevices[someone.home] ~= 'Thuis'
		    and device_svalue(temp.porch) <= nest_conf.trigger_temp_autumn			
			and (uservariables[var.heat_override] == 1 or uservariables[var.heat_override] == 2)		
		then
			...
			then
				commandArray['SetSetPoint:'..nest_conf.setpoint_idx]=tostring(nest_conf.eco_temp_summer)
				if uservariables[var.heat_override] ~= 2 then commandArray["Variable:" .. var.heat_override .. ""]= '2' end
			end
...
--
		...
		if devicechanged[lux_sensor.living]			
			and otherdevices[someone.home] == 'Thuis'
			and (uservariables[var.preheat_override] == 1 or uservariables[var.heat_override] == 2)		
		then
			if uservariables[var.preheat_override] == 1 then commandArray["Variable:" .. var.preheat_override .. ""]= '0' end
			if uservariables[var.heat_override] == 2 then commandArray["Variable:" .. var.heat_override .. ""]= '0' end			
		end		
