...
### Domoticz Various Backup Folders	
	...
	DOMO_BACKUP_CSS_FOLDER="css" 																# Domoticz custom css Backup Folder	
...
### Which unwanted files to remove from the backup
	...
	file14="plugins/siewert-gsm/__pycache__/plugin.cpython-35.pyc"	
	file15="plugins/jerina-gsm/__pycache__/plugin.cpython-35.pyc"	
	file16="plugins/natalya-gsm/__pycache__/plugin.cpython-35.pyc"
	file17="plugins/siewert-laptop/__pycache__/plugin.cpython-35.pyc"	
	file18="plugins/jerina-laptop/__pycache__/plugin.cpython-35.pyc"	
	file19="plugins/zwave-battery-level/__pycache__/plugin.cpython-35.pyc"	
...
sleep 1
		echo "--- $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/$DOMO_BACKUP_CSS_FOLDER created"
		mkdir $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/$DOMO_BACKUP_CSS_FOLDER		
sleep 1
		echo "--- Done!"	
		sleep 2
...
sleep 1
		echo "--- Backing up custom CSS file"
		cp -R $DOMO_DIR/www/css/style.css $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/$DOMO_BACKUP_CSS_FOLDER		
sleep 1
...
sleep 1	
		...
		echo "--- Removed $file14"		
		rm -rf $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/plugins/siewert-gsm/__pycache__
		else
...
sleep 1	
		...
		echo "--- Removed $file15"		
		rm -rf $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/plugins/jerina-gsm/__pycache__
		else
...
sleep 1	
		...
		echo "--- Removed $file16"		
		rm -rf $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/plugins/natalya-gsm/__pycache__
		else
		echo "--- $file16 doesn't exist or already removed!"
		fi
sleep 1	
		if [ -f $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/$file17 ] ; then
		echo "--- Removed $file17"		
		rm -rf $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/plugins/siewert-laptop/__pycache__
		else
		echo "--- $file17 doesn't exist or already removed!"
		fi
sleep 1	
		if [ -f $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/$file18 ] ; then
		echo "--- Removed $file18"		
		rm -rf $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/plugins/jerina-laptop/__pycache__
		else
		echo "--- $file18 doesn't exist or already removed!"
		fi
sleep 1	
		if [ -f $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/$file19 ] ; then
		echo "--- Removed $file19"		
		rm -rf $MOUNT/$DOMO_BACKUP_HOME/$DOMO_BACKUP_FOLDER/plugins/zwave-battery-level/__pycache__
		else
		echo "--- $file19 doesn't exist or already removed!"
		fi			
sleep 1
